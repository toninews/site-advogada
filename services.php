<section id="services" class="area-destaque container-fluid">
  <video
    ...
    playsinline
    preload="metadata"
    poster="/site-advogada/images/optimized/direito-criminal-1280.webp"
    aria-hidden="true"
  >
    <source src="/site-advogada/images/services-optimized.mp4" type="video/mp4" />
  </video>
  ...
  <div class="row center-xs area-destaque-row">
    <div class="col-xs-12 col-md-4">
      <div class="conteudo">
        ...
        <a href="" class="btn btn-services">Chame Agora</a>
      </div>
    </div>
