        ...
        <div class="footer-social" aria-label="Redes sociais">
          <a href="#" class="footer-social-link" aria-label="Facebook" title="Facebook">
            <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
              <path d="M13.5 8.5h2V6h-2.3c-2.2 0-3.7 1.4-3.7 3.8V12H7v2.5h2.5V21h2.8v-6.5h2.7L15.5 12h-3.2V9.9c0-.9.3-1.4 1.2-1.4z" />
            </svg>
          </a>
          <a href="#" class="footer-social-link" aria-label="Instagram" title="Instagram">
            <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
              <path d="M16.5 3h-9A4.5 4.5 0 0 0 3 7.5v9A4.5 4.5 0 0 0 7.5 21h9a4.5 4.5 0 0 0 4.5-4.5v-9A4.5 4.5 0 0 0 16.5 3zm2 13.5a2 2 0 0 1-2 2h-9a2 2 0 0 1-2-2v-9a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v9zm-6.5-8A4 4 0 1 0 16 12a4 4 0 0 0-4-3.5zm0 5.5A1.5 1.5 0 1 1 13.5 12 1.5 1.5 0 0 1 12 14zm4.4-6.1a.95.95 0 1 0 .95.95.95.95 0 0 0-.95-.95z" />
            </svg>
          </a>
          <a href="#" class="footer-social-link" aria-label="LinkedIn" title="LinkedIn">
            <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
              <path d="M6.7 8.6a1.7 1.7 0 1 1 0-3.4 1.7 1.7 0 0 1 0 3.4zM5.3 10h2.8v8.7H5.3V10zm4.7 0h2.7v1.2h.1c.4-.7 1.4-1.5 2.9-1.5 3.1 0 3.7 2 3.7 4.7v4.3h-2.8v-3.8c0-.9 0-2.1-1.3-2.1s-1.5 1-1.5 2v3.9H10V10z" />
            </svg>
          </a>
        </div>
      </div>
